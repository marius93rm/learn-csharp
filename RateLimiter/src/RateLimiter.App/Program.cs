...
internal static class Program
{
    ...
    private static async Task Main(string[] args)
    {
        ...
        // TODO Milestone 4: collegare Console.CancelKeyPress a cts.Cancel() per supportare CTRL+C.

        try
        {
            // TODO Milestone 1: Passare un vero CancellationToken (es. cts.Token) quando la logica sarà pronta.
            var results = await simulator.RunBatchAsync(totalRequests, CancellationToken.None);
